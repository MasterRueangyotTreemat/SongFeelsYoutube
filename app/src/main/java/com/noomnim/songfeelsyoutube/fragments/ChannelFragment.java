...
import com.noomnim.songfeelsyoutube.adapters.VideoPostAdapter;
...
public class ChannelFragment extends Fragment {
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyAvtIzvpUvCj7VOut4opeOkROyQZ3hD7mA";
    private static String CHANNEL_ID = "UCoMdktPbSTixAyNGwb-UYkQ";
    private static String CHANNEL_GET_URL = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=date&channelId=UCoMdktPbSTixAyNGwb-UYkQ&maxResults=20&key=AIzaSyAvtIzvpUvCj7VOut4opeOkROyQZ3hD7mA";
        ...
        protected void onPostExecute(String response) {
            ...
            if (response != null) {
                try {
                    ...
                    Log.d( "SongFeels", "mListSize " + mListData.size() );
